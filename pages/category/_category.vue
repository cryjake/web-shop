<template>
  <section>
    ...
    <div class="container my-margin-top">
      ...
      <div class="columns">
        <!-- <div class="column is-one-quarter">
          <FilterSearch :category="category"></FilterSearch>
        </div> -->
        <div class="column">
          <section>
            <div class="columns">
...
<script>
  ...
  export default {
    ...
    async asyncData ({ store, params, query, route, error }) {
      try {
        let info = ''
        let current = (query.page !== undefined) ? Number(query.page) : 1
        let perPage = 10
        ...
        await store.dispatch('product/getProductsForGoogle', {
          page: page,
          query: myquery,
          category: category
        },
        ...
        return { info: info, category: params.category, current: current, perPage: perPage }
      } catch (e) {
        console.log(e)
        error({ statusCode: 500, message: 'Got an error ' + e })
        // console.log(e)
      }
    },
    /* created () {
