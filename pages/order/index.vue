  ...
  export default {
    ...
    methods: {
      doNext () {
        ...
        if ((this.customer.phone === undefined || this.customer.phone === null || this.customer.phone === '')) { hasErrors.push({'error': 'noValidPhone', 'message': 'Please edit your Personal Details to add your phone number'}) }
